...
```{python}
# Q1
travelers = email.select(pl.col("age", "avg_distance", "n_purchase"))
travelers = travelers.with_columns(
...
```{python}
#Q2
q2 = px.scatter(travelers, x = "age", y = "avg_distance")
q2
```
...
```{python}
# Q4
q4 = px.histogram(travelers, x = "age")
q4
```
...
```{python}
# Q7
new_data = travelers.group_by("age_group").agg(
  pl.col("avg_distance")
  .mean()
  .alias("mean_distance")
)

q7 = px.bar(new_data, x = "age_group", y = "mean_distance")
