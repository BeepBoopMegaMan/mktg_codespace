...
categorical_features = ['name','host_name', 'city', 'area']  # text columns
numeric_features = ['price', 'reply time','host since', 'total reviewers number', 'host Certification', 'room type', 'accomodates', 'bathrooms', 'bedrooms', 'beds', 'host response rate'] #numerical columns
