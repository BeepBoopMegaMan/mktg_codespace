...
q2 = (
    df_campaigns.join(df_responses, on="campaign_id", how="right")
)
...
q3 = (
    df_campaigns.join(df_responses, on="campaign_id", how="full", coalesce=False)
)
...
q6 = (
    df_responses.pivot("campaign_id", index="customer_id", values="response")
)
...
q7 = (
    df_budgets.unpivot(["Q1","Q2","Q3","Q4"], index=["campaign_id", "campaign_name"])
)
